        ...
        <>
            ...
            <div className="TCOuterContainer">
                ...
                <div className="TCContent">
                    ...
                    <p>These terms and conditions outline the rules and regulations for the use of FRISKA's Website, located at https://friskanow.com/.
                    </p> <br />
                    <p>
                    ...
                    <h2>Cookies</h2> <br />
                    <p>We employ the use of cookies. By accessing FRISKA, you agreed to use cookies in agreement with FRISKA's Privacy Policy.
                    </p> <br />
                    ...
                    <h2>License</h2> <br />
                    <p>Unless otherwise stated, FRISKA and/or its licensors own the intellectual property rights for all material on FRISKA. All intellectual property rights are reserved. You may access this from FRISKA for your own personal use subject to restrictions set in these terms and conditions.</p> <br />
                    <p>You must not:</p> <br />
                    <ul>
                    ...
                    <p>You hereby grant FRISKA a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats, or media.
                    </p> <br />
