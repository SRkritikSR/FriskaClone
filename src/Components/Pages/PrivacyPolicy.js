            ...
            <div className="PPOuterContainer">
                ...
                <div className="PPContent">
                    ...
                    <ul>
                        ...
                        <li> <b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to FRISKA, Pune, India.
                        </li> <br />
                        ...
                        <li><b>Country</b> refers to India</li> <br />
                        <li> <b>Device</b> means any device that can access the Service such as a computer, a cell phone, or a digital tablet. </li> <br />
                        <li> <b>Personal Data</b> is any information that relates to an identified or identifiable individual.
                        </li> <br />
                        <li><b>Service</b> refers to website.</li> <br />
                        ...
                        <li><b>Usage Data</b> refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).
                        </li> <br />
                        <li><b>Website</b>refers to FRISKA, accessible from <a href="https://friskanow.com/">https://friskanow.com/</a>
                        </li> <br />
                        <li><b>You</b> mean the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.
                        </li>
                    </ul>
                    <br />
                    <br />
                    ...
                    <ul>
                        ...
                        <li> <b>To manage Your Account:</b> to manage Your registration as a user of the Service. The Personal Data You provide can give You access to different functionalities of the Service that are available to You as a registered user.
                        </li> <br />
                        ...
                        <li> <b>To provide You</b> with news, special offers, and general information about other goods, services, and events that we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such information.
                        </li> <br />
                        <li><b>To manage Your requests:</b>To attend to and manage Your requests to Us.
                        </li> <br />
                    ...
                    <ul>
                        ...
                        <li><b>With business partners:</b>We may share Your information with Our business partners to offer You certain products, services, or promotions.
                        </li> <br />
                        <li><b>With other users:</b>when You share personal information or otherwise interact in public areas with other users, such information may be viewed by all users and may be publicly distributed outside.
                        </li> <br />
                    ...
                    <ul>
                        ...
                        <li>By phone number: +91 8983176450</li> <br />
                    </ul>
                </div>
            </div>
            <Footer />
